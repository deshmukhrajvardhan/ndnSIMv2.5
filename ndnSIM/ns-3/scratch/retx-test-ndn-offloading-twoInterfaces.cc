...
main(int argc, char* argv[])
{
  ...
  */
  ...
  ndn::StrategyChoiceHelper::Install(pedestrians,"/", "/localhost/nfd/strategy/broadcastretx");//broadcast")
  ndn::StrategyChoiceHelper::Install(vehicles,"/", "/localhost/nfd/strategy/broadcastretx");//broadcast");
  ...
  ndn::StrategyChoiceHelper::Install(dtdepot,"/", "/localhost/nfd/strategy/multicast");//broadcast");
