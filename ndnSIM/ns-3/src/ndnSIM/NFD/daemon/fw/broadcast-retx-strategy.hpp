...
#ifndef NFD_DAEMON_FW_BROADCAST_RETX_STRATEGY_HPP
#define NFD_DAEMON_FW_BROADCAST_RETX_STRATEGY_HPP
 ...
 */
class BroadcastRetxStrategy : public Strategy
{
public:
  explicit
  BroadcastRetxStrategy(Forwarder& forwarder,const Name& name= getStrategyName());
...
private:
  ...
  std::string m_file={"/VM1_D2D_ndnSIM/ndnSIMv2.5/ndnSIM/ns-3/scratch/energy_level.txt"};//{"./../../../../../scratch/energy_level"};
...
#endif // NFD_DAEMON_FW_BROADCAST_RETX_STRATEGY_HPP
