...
#ifndef energyTRACER_H
#define energyTRACER_H
 ...
 */
class energyTracer : public SimpleRefCount<energyTracer> {
public:
  /**
   ...
   */
  energyTracer(shared_ptr<std::ostream> os, Ptr<Node> node);
   ...
   */
  energyTracer(shared_ptr<std::ostream> os, const std::string& node);
...
private:
  std::string m_node;
  //double m_dist,m_velocity;
  double m_energyLevel;
  double m_initPowerLevelA = 2.45;
  Ptr<Node> m_nodePtr;
